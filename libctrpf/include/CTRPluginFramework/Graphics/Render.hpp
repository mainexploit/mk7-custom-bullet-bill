...
namespace CTRPluginFramework
{
    ...
    public:
        ...
        */
        ...
        public:
            ...
            /**
             * @brief Draws an string using the linux font (6x10 pixels per character)
             *
             * @param str String to draw
             * @param posX Starting X position of the string
             * @param posY Starting Y position of the string
             * @param foreground Foreground color of the string
             * @param background Background color of the string
             */
            void     DrawLinuxString(const std::string& str, int posX, int posY, const Color& foreground = Color::White, const Color& background = Color::Black);
    ...
    private:
        static std::unordered_map<int, std::u16string> _randomSets;
    };
