...
namespace CTRPluginFramework
{
    ...
    public:
        ...
        /**
         * @brief Setting to true will disable most of the OSD features to reduce CPU usage:
         * - OSD callbacks
         * - Notifications
         * - Anything else that writes to screen (excluding menus)
         */
        static bool     LightweightMode;
