...
namespace CTRPluginFramework
{
    ...
    public:
        ...
        /**
         * @brief Converts an UTF8 string into an UTF16 std::u16string (use the .c_str() method to obtain the raw characters).
         *
         * @param out Output std::u16string where the UTF16 characters will be appended.
         * @param utf8str Input UTF8 C string.
         */
        static void         ConvertUTF8ToUTF16(std::u16string& out, const char* utf8str);
         ...
         */
        static void         ConvertUTF8ToUTF16(std::u16string& out, const std::string &utf8str) {ConvertUTF8ToUTF16(out, utf8str.c_str());}
         ...
         */
        static void         ConvertUTF16ToUTF8(std::string& out, const char16_t* utf16str);

        /**
         * @brief Converts an UTF16 string into an UTF8 string (use the .c_str() method to obtain the raw characters).
         *
         * @param out Output string where the UTF8 characters will be appended.
         * @param utf8str Input UTF16 std::u16string.
         */
        static void         ConvertUTF16ToUTF8(std::string& out, const std::u16string &utf16str) {ConvertUTF16ToUTF8(out, utf16str.c_str());}
